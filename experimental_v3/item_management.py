...
class AddItem(QDialog):
    ...
    def step_a(self, item_name, barcode, expire_dt, item_type, brand, sales_group, supplier, cost, discount, sell_price, effective_dt):
        ...
        # print('item_name:', item_name_data)
        # print('barcode:', barcode_data)
        # print('expire_dt:', expire_dt_data)
        # print('item_type:', item_type_data)
        # print('brand:', brand_data)
        # print('sales_group:', sales_group_data)
        # print('supplier:', supplier_data)
        # print('cost:', cost_data)
        # print('discount:', discount_data)
        # print('sell_price:', sell_price_data)
        # print('effective_dt:', effective_dt_data)
